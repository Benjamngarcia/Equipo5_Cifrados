...
function inicio() {
    ...
    document.getElementById("cifrar").addEventListener("click",
        function () {  //CLICK EN EL BOTÓN CIFRAR
            let texto = document.getElementById("mensaje").value;
            let desplazamiento = document.getElementById("desplazamiento").value;
            document.getElementById("resultadocifrado").value = cifrar(texto, desplazamiento);
        },
        true);

    document.getElementById("descifrar").addEventListener("click",
        function () {  //CLICK EN EL BOTÓN DESCIFRAR 
            let texto = document.getElementById("mensaje").value;
            let desplazamiento = document.getElementById("desplazamiento").value;
            document.getElementById("resultadocifrado").value = descifrar(texto, desplazamiento);
        },
        true);
}
